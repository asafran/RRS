...
//
//------------------------------------------------------------------------------
ModelPartAnimation::ModelPartAnimation(vsg::MatrixTransform *transform)
    : transform(transform)
    , path(nullptr)
    , pos(0.0)
    , ref_pos(0.0)
    , lastTime(1.0)
{
    vsg::AnimationPathCallback *callback = dynamic_cast<vsg::AnimationPathCallback *>(transform->getUpdateCallback());
